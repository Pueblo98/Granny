...
(() => {
  ...
  function create(o) {
    ...
    function disclosure(kind){
      const data={microphone:['Microphone','Optional voice entry, only after Talk. In this browser Talk uses fictional words; no audio is captured, kept or sent. Android owns the actual grant.'],screen:['Screen help','Only a screen you choose/share or an Android-approved scope. This browser uses supplied fictional screens; no screen is captured or sent.'],cloud:['Cloud processing','Off in the static prototype. No data goes to a provider here. Some requests are unavailable. The separately authorized Demo connection has its own explicit consent.']}[kind];
