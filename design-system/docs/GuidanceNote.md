...
CMP-008. Inline explanation for a recoverable obstacle.

Describes the current state and the way forward. It never tells the person they did something wrong, and never asks them to remember a step they cannot see.
