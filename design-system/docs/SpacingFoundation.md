...
The 4dp spacing scale and the layout rules that use it.

A review sheet. Grouping in this system comes from spacing and rules rather than a stack of raised cards.
