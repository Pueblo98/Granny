...
Open Day against Bright Signal on the identical specimen.

A review sheet. Same component, same content, same structure in both columns, so a preference between them is about the territory rather than about a layout difference.
