...
Corner radii per territory, and the elevation rule.

A review sheet. Radius is the one dimension that differs between the territories: Open Day 12/16dp, Bright Signal 8dp. Role names are identical in both.
