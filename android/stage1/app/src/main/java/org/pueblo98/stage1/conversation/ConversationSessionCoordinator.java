...
public final class ConversationSessionCoordinator {
    ...
    public ConversationSessionCoordinator(TextScaleController textScale) { this(textScale, null, () -> {}); }
    public ConversationSessionCoordinator(TextScaleController textScale, TextScaleStore outcomeObserver) { this(textScale, outcomeObserver, () -> {}); }
    public ConversationSessionCoordinator(TextScaleController textScale, Runnable cancelCleanup) { this(textScale, null, cancelCleanup); }
    public ConversationSessionCoordinator(TextScaleController textScale, TextScaleStore outcomeObserver, Runnable cancelCleanup) {
        this.textScale = textScale; this.outcomeObserver = outcomeObserver; this.cancelCleanup = cancelCleanup;
    }
    ...
    public Result approve() {
        ...
        permit = new Permit(generation, revision, consequence); surface = Surface.ACTIVE;
    ...
    public Result dispatchApproved(long queuedGeneration) {
        ...
        if ((applied == TextScaleController.OperationResult.APPLIED || applied == TextScaleController.OperationResult.ALREADY_APPLIED)
    ...
    public Result stop(Runnable cleanup) { invalidate(); textScale.cancelPreview(); if (cleanup != null) cleanup.run(); cancelCleanup.run(); surface = Surface.IDLE; message = "Stopped. You can talk again or type."; return Result.ACCEPTED; }
    ...
    private boolean independentlyObserved() {
    ...
    private static final class Permit {
        final long generation, revision; final String consequence;
        Permit(long generation, long revision, String consequence) { this.generation = generation; this.revision = revision; this.consequence = consequence; }
