...
| Microphone/speech | User-granted runtime permission plus speech provider; [SpeechRecognizer](https://developer.android.com/reference/android/speech/SpeechRecognizer) | May use remote service; on-device availability must be checked; not intended as unrestricted continuous recognition | Quiet/noisy rooms, offline pack/provider, interruption and mic denial; EVAL-005/007/009 |
