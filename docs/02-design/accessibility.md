...
| A11Y-11 | A room is identifiable through a persistent written name/purpose and stable navigation; [reviewed atmosphere assets](context-room-visual-system.md), color, spatial memory and conversation are never the sole route. Home's CMP-012 uses written Previous/Next for real overflow plus See all rooms; swipe or a partial portrait is never the only path. | SCR-003/016/017 at 200%, combined 300%, no-room/one-room/all-fit/overflow, grayscale/reduced motion, decor removed, image failure, TalkBack/keyboard/switch and model-offline direct-findability review; EVAL-012 |
