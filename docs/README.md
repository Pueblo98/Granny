...
**Start here for development oversight:** [Cockpit](Cockpit.md) · [visual map](Development.canvas) · [session/message views](10-execution/cockpit.base) · [agent board](10-execution/agent-board.md). [Cockpit guide](10-execution/cockpit-guide.md) owns update/refresh rules. [Conversation-first build](02-design/conversation-first-plan.md) remains the shell foundation; the first integrated Home/Rooms/outcomes/support iteration is owner-reviewed. Current work follows bounded native and feasibility-evidence slices rather than another general frontend batch.

**Active native sequence:** [T-122](10-execution/backlog.md#t-122) implements the optional Setup and Capability Center for review with host evidence only. It is followed by the narrow T-101 C2 selected-package/retention/egress packet and then a separate fictional local message-draft clarification/exact-preview slice. No item in that sequence admits an external route by itself.
