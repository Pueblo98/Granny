...
**Active experience direction:** [Context Rooms](02-design/context-rooms.md) · [accepted room decision](09-decisions/ADR-0015-context-rooms.md) · [selected Explicit Scroll Row Home](02-design/mockups/2026-09-19-harbour-blue-home/selected-explicit-scroll-row/README.md) · [accepted Home decision](09-decisions/ADR-0016-explicit-home-room-row.md) · [visual asset system](02-design/context-room-visual-system.md) · [six-room visual catalog](02-design/context-room-starter-catalog.md) · [iteration-1 asset metaprompt](02-design/context-room-iteration-1-metaprompt.md) · [T-119 prototype packet](10-execution/task-packets.md#t-119-packet). Preserve one global assistant and conversation-first Home; future design/development starts from the selected open portrait row with fictional data before persistent implementation.
...
Native voice slices: Simon accepted [explicit tap-to-talk and Android on-device recognition](09-decisions/ADR-0011-explicit-activation-and-access.md) on 2026-09-20. [T-120](10-execution/backlog.md#t-120) owns the first bounded input shell and conservative non-model cleanup. [T-121](10-execution/backlog.md#t-121) adds explicit Android spoken readback, Stop/Repeat, Sound and previewed rate controls while retaining written text as the complete fallback. Host evidence is separate from pending exact-device input/output evidence. Whisper-class, cleanup-LLM, cloud, ambient capture and automatic speech remain excluded.
