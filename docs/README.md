...
| What is accepted versus proposed? | [ADR index](09-decisions/README.md); nine accepted records including the MVP control posture and automatic-memory/adaptive-communication decision, two proposals, one deprecated historical record |
