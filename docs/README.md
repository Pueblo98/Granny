...
**Active experience direction:** [Context Rooms](02-design/context-rooms.md) · [accepted room decision](09-decisions/ADR-0015-context-rooms.md) · [selected Explicit Scroll Row Home](02-design/mockups/2026-09-19-harbour-blue-home/selected-explicit-scroll-row/README.md) · [accepted Home decision](09-decisions/ADR-0016-explicit-home-room-row.md) · [visual asset system](02-design/context-room-visual-system.md) · [six-room visual catalog](02-design/context-room-starter-catalog.md) · [T-119 prototype packet](10-execution/task-packets.md#t-119-packet). The integrated fictional browser iteration is on `main`; Simon's 2026-09-20 walkthrough found it cohesive and good for now. A bounded [Room-aware OpenRouter task](10-execution/sessions/2026-09-20-room-chat-openrouter.md) now connects one assistant across Home and all fictional Rooms on its review branch. Preserve one global assistant and conversation-first Home; persistent production behavior remains separately gated.
