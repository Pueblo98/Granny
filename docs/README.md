...
**Active native sequence:** [T-122](10-execution/backlog.md#t-122) implements the optional Setup and Capability Center for review with host evidence only; [T-123](10-execution/backlog.md#t-123) implements the fictional local message-draft clarification/exact-preview flow for review. Neither slice admits an external message route.
