...
**Active experience direction:** [Context Rooms](02-design/context-rooms.md) · [accepted room decision](09-decisions/ADR-0015-context-rooms.md) · [selected Explicit Scroll Row Home](02-design/mockups/2026-09-19-harbour-blue-home/selected-explicit-scroll-row/README.md) · [accepted Home decision](09-decisions/ADR-0016-explicit-home-room-row.md) · [visual asset system](02-design/context-room-visual-system.md) · [six-room visual catalog](02-design/context-room-starter-catalog.md) · [T-119 prototype packet](10-execution/task-packets.md#t-119-packet). The integrated fictional browser iteration is on `main`; Simon's 2026-09-20 walkthrough found it cohesive and good for now. A bounded [Room-aware OpenRouter task](10-execution/sessions/2026-09-20-room-chat-openrouter.md) connects one assistant across Home and all fictional Rooms; its [conversation/evidence extension](10-execution/sessions/2026-09-20-conversation-evidence-store.md) gives synthetic conversations exact message-owned citations on a review branch. Preserve one global assistant and conversation-first Home; persistent production behavior remains separately gated.
...
Local backend/MCP experiment: [versioned runtime contract](04-architecture/conversation-runtime-contract.md) · [conversation/evidence schema](04-architecture/conversation-evidence-store.md) · [proposed storage ADR](09-decisions/ADR-0017-local-conversation-evidence-store.md) · [startup/tests](../prototypes/conversation-runtime/README.md) · [T-117 evidence](10-execution/sessions/2026-09-15-mcp-backend-integration.md) · [Room-aware extension](10-execution/sessions/2026-09-20-room-chat-openrouter.md). The [T-103 authority core](../prototypes/t103-authority-core/README.md) is complete for pure fake replay. Actual local execution uses fictional data; the next external slice still depends on T-101 route/admission evidence and production Android gates remain unchanged.
...
| Where are component/data/trust boundaries? | [Root map](../ARCHITECTURE.md), [system contract](04-architecture/system-overview.md), [synthetic conversation/evidence store](04-architecture/conversation-evidence-store.md) |
