...
**Active experience direction:** [Context Rooms](02-design/context-rooms.md) · [accepted room decision](09-decisions/ADR-0015-context-rooms.md) · [selected Explicit Scroll Row Home](02-design/mockups/2026-09-19-harbour-blue-home/selected-explicit-scroll-row/README.md) · [accepted Home decision](09-decisions/ADR-0016-explicit-home-room-row.md) · [visual asset system](02-design/context-room-visual-system.md) · [six-room visual catalog](02-design/context-room-starter-catalog.md) · [T-119 prototype packet](10-execution/task-packets.md#t-119-packet). The integrated fictional browser iteration is on `main`; Simon's 2026-09-20 walkthrough found it cohesive and good for now, including the Home/Rooms scrolling refinement. Preserve one global assistant and conversation-first Home; persistent production behavior remains separately gated.

**Current visual design system:** [FINAL — Harbour Blue](02-design/mockups/2026-09-19-style-boards/final-harbour-blue/README.md) · [SELECTED — Explicit Scroll Row Home](02-design/mockups/2026-09-19-harbour-blue-home/selected-explicit-scroll-row/README.md) · [shared conversation state surfaces](02-design/shared-conversation-state-surfaces.md) · [authorized Home implementation metaprompt](02-design/mockups/2026-09-19-harbour-blue-home/selected-explicit-scroll-row/FRONTEND-IMPLEMENTATION-METAPROMPT.md) · [iteration history and feedback](02-design/mockups/2026-09-19-style-boards/README.md) · [all mockups](02-design/mockups/README.md).

**Start here for development oversight:** [Cockpit](Cockpit.md) · [visual map](Development.canvas) · [session/message views](10-execution/cockpit.base) · [agent board](10-execution/agent-board.md). [Cockpit guide](10-execution/cockpit-guide.md) owns update/refresh rules. [Conversation-first build](02-design/conversation-first-plan.md) remains the shell foundation; the first integrated Home/Rooms/outcomes/support iteration is owner-reviewed. Simon selected setup/capability status followed by a bounded local fictional draft as the next native product slices. The [narrow C2 packet](10-execution/t101-c2-identity-retention-egress-packet.md) and refreshed [route inventory](08-research/2026-09-19-t101-route-inventory.md) own the separate feasibility blockers.

**Active native sequence:** [T-122](10-execution/backlog.md#t-122) implements the optional Setup and Capability Center for review; [T-123](10-execution/backlog.md#t-123) implements the fictional local message-draft clarification/exact-preview flow; [T-124](10-execution/backlog.md#t-124) tries Android's package-targeted media play-from-search handoff in the debug evidence lab. One [TBL-01/YT Music run](08-research/2026-09-20-t124-media-handoff-device-evidence.md) reached the exact app but its session remained paused. The media slice reports requested/unknown rather than playback, and no slice admits external message send or CAP-10 play/pause.
...
Native voice slices: Simon accepted [explicit tap-to-talk and Android on-device recognition](09-decisions/ADR-0011-explicit-activation-and-access.md) on 2026-09-20. [T-120](10-execution/backlog.md#t-120) owns the bounded input shell and continuity repair. [T-121](10-execution/backlog.md#t-121) adds explicit Android spoken readback, Stop/Repeat, Sound and previewed rate controls while retaining written text as the complete fallback. [Follow-up device feedback](08-research/2026-09-20-native-tablet-followup-feedback.md) is positive for the repaired flow and requested accessibility smoke checks; voice naturalness remains unsatisfactory and the full versioned matrix is incomplete. Whisper-class, cloud, ambient capture and automatic speech remain excluded until separately reviewed.

Closed device-control experiment: [T-125](10-execution/backlog.md#t-125) and its [host bridge](../experiments/local-device-bridge/README.md) define twenty fixed public cases without a model-facing raw ADB/shell/coordinate surface. Host denial tests pass; the first run stopped safely at `device_missing`, so no device task evidence or Raspberry Pi decision exists yet.

Local backend/MCP experiment: [versioned runtime contract](04-architecture/conversation-runtime-contract.md) · [startup/tests](../prototypes/conversation-runtime/README.md) · [T-117 evidence](10-execution/sessions/2026-09-15-mcp-backend-integration.md). The [T-103 authority core](../prototypes/t103-authority-core/README.md) is complete for pure fake replay. Actual local execution uses fictional data; the next external slice still depends on T-101 route/admission evidence and production Android gates remain unchanged.
...
| What does the user see/control in every state? | [Product design spec](02-design/product-design-spec.md), [semantic components](02-design/design-system.md), [shared conversation state surfaces](02-design/shared-conversation-state-surfaces.md), [Context Rooms direction](02-design/context-rooms.md), [room visual system](02-design/context-room-visual-system.md), [six-room catalog](02-design/context-room-starter-catalog.md) |
...
| What is accepted versus proposed? | [ADR index](09-decisions/README.md); twelve accepted records including the MVP control posture, automatic-memory/adaptive-communication, bounded composition, Context Rooms and Explicit Scroll Row Home, two proposals and two deprecated historical records |
