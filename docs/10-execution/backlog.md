...
- **Status:** in progress — [Step A routes and Step B/C worksheets](../08-research/2026-09-19-t101-route-inventory.md) and a [partial manual `TBL-01` inventory](../08-research/2026-09-19-t101-physical-inventory.md) exist. The [C2 Android 16 source scaffold](../../experiments/c2-screen-explanation/README.md) is prepared with synthetic fixture/observer boundaries and planned cases, but is unbuilt and unrun: no host Android toolchain is installed and no dependency download, tablet install, capture or actuation was authorized. Selected-package identity is unresolved. T-101 is not complete; GATE-03/04/06 device conditions remain open.
