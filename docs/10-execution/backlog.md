...
- **Status:** in progress — [Step A routes and Step B/C worksheets](../08-research/2026-09-19-t101-route-inventory.md), a [partial manual `TBL-01` inventory](../08-research/2026-09-19-t101-physical-inventory.md) and a bounded [C2 device ledger](../08-research/2026-09-19-t101-c2-device-evidence.md) exist. A repaired run closes the synthetic C2-06 stale-prior-frame regression twice and demonstrates visible Stop in C2-08. C2 is still not admitted: C2-09 lacks prompt lock cleanup, C2-10 is inconclusive, C2-12 fails task-removal containment, and selected-package identity plus independent retention/egress oracles remain unresolved. A second source-only repair for lifecycle cleanup and content-free state/result recovery passes 32 host cases but is unrun on Android. T-101 is not complete; GATE-03/04/06 device conditions remain open.
