...
- **Status:** in progress — selected Home and the six-room fictional frontend slice are implemented for browser review in the [isolated session](sessions/2026-09-19-context-rooms-frontend.md). Full T-119 remains incomplete: typed context/privacy, cross-room admission, membership receipts/Undo, archive/delete and device/human evidence remain unrun or later work. No persistent room implementation exists.
