...
- **Status:** in progress — [Step A routes and Step B/C worksheets](../08-research/2026-09-19-t101-route-inventory.md) prepared 2026-09-19; a [partial manual physical inventory](../08-research/2026-09-19-t101-physical-inventory.md) now identifies `TBL-01` as Samsung `SM-X238U`, Android 16 / One UI 8.0 and records partial display/input/access/app state. It is user-reported, not independently rechecked; API/window/speech/app/grant/network/build gaps and every capability experiment remain unrun. T-101 is not complete; GATE-03/04/06 device conditions remain open.
...
- **Scope / authority:** Simon adopted Context Rooms as the active experience direction and asked the notebook/future plan to align on 2026-09-19. On the same date he separately authorized the next development session to implement the selected Home frontend with placeholders. That authority covers only the bounded SCR-003/CMP-010–012 Home checkpoint in the [implementation metaprompt](../02-design/mockups/2026-09-19-harbour-blue-home/selected-explicit-scroll-row/FRONTEND-IMPLEMENTATION-METAPROMPT.md); the complete Rooms library/interior and persistent contract remain later slices.
