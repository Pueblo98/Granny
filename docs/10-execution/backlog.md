...
- **Status:** in progress — [Step A routes and Step B/C worksheets](../08-research/2026-09-19-t101-route-inventory.md), a [partial manual `TBL-01` inventory](../08-research/2026-09-19-t101-physical-inventory.md) and a bounded [C2 device ledger](../08-research/2026-09-19-t101-c2-device-evidence.md) exist. C2-06 failed twice, C2-08 was aborted after temporary tablet unresponsiveness, C2-09 is inconclusive and C2-10/12 are unrun. A source-only repair now passes 29 host cases and has new hashed APKs, but no repaired artifact has run on Android. Selected-package identity and independent lifecycle/retention/egress oracles remain unresolved. T-101 is not complete; GATE-03/04/06 device conditions remain open.
