...
- **Status:** in progress — [Step A routes and Step B/C worksheets](../08-research/2026-09-19-t101-route-inventory.md), a [partial manual `TBL-01` inventory](../08-research/2026-09-19-t101-physical-inventory.md) and a bounded [C2 device ledger](../08-research/2026-09-19-t101-c2-device-evidence.md) exist. Three device runs now close the synthetic C2-06 stale-prior-frame regression and provide positive bounded Stop, lock, resize and task-removal projection-cleanup observations. C2 is still not admitted: C2-12 reopened with the stale C2-10 result, selected-package identity is absent, and independent retention/egress oracles remain unresolved. Repair the activity/ledger generation handoff in source before any freshly authorized device run. T-101 is not complete; GATE-03/04/06 device conditions remain open.
