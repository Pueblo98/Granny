...
| Platform/distribution feasibility | [Assessment](../08-research/android-stage-1-feasibility.md), [T-101 route inventory](../08-research/2026-09-19-t101-route-inventory.md) and [C2 device ledger](../08-research/2026-09-19-t101-c2-device-evidence.md) | Needs evidence; repaired C2 has bounded positive protected-scene, Stop, lock, resize and task-removal recovery observations, but selected-package/retention/egress oracles remain incomplete and idle Stop state is unclear; no route/store approval |
...
- **Next dependency-ordered backend/evidence work:** [T-101](backlog.md#t-101) has Step A/C plans, a partial Step B inventory and four bounded [C2 device runs](../08-research/2026-09-19-t101-c2-device-evidence.md). The ordered generation regression now passes; repair the idle Stop control state in source and prepare independent selected-package, retention and egress oracles. T-104 waits for sent-photo route/device evidence and the applicable device-safety boundary.
