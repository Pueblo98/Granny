...
- **Next dependency-ordered backend/evidence work:** [T-101](backlog.md#t-101) has Step A/C plans, a partial Step B inventory and two bounded [C2 device runs](../08-research/2026-09-19-t101-c2-device-evidence.md). Repair explicit screen-off/task-removal cleanup and content-free state/result recovery in source and host tests before seeking fresh exact device authority. T-104 waits for sent-photo route/device evidence and the applicable device-safety boundary.
