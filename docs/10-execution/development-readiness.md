...
- **Next dependency-ordered backend/evidence work:** [T-101](backlog.md#t-101) has Step A/C plans, a partial Step B inventory and three bounded [C2 device runs](../08-research/2026-09-19-t101-c2-device-evidence.md). Repair and host-test the activity/ledger generation handoff exposed by C2-12 before considering another exact device authorization. T-104 waits for sent-photo route/device evidence and the applicable device-safety boundary.
