...
- **Next dependency-ordered backend/evidence work:** [T-101](backlog.md#t-101) desk route inventory and physical-inventory preparation. Desk research needs no tablet; physical commands require user-provided access and explicit authorization. T-104 waits for T-101 route/device evidence and the applicable device-safety boundary.
