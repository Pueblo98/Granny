...
| Platform/distribution feasibility | [Assessment](../08-research/android-stage-1-feasibility.md) and [T-101 route inventory](../08-research/2026-09-19-t101-route-inventory.md) | Needs evidence; current official-source matrices and unrun worksheets exist, no measured route/store approval |
...
- **Next dependency-ordered backend/evidence work:** [T-101](backlog.md#t-101) Step B read-only physical inventory after explicit tablet/access authorization, followed only by separately authorized Step C experiments. [Step A and both worksheets](../08-research/2026-09-19-t101-route-inventory.md) are prepared; device evidence remains unrun. T-104 waits for sent-photo route/device evidence and the applicable device-safety boundary.
