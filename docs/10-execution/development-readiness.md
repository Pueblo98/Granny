...
| Figma/token handoff | [Figma](../02-design/figma.md), [actual partial build](../02-design/figma-prototype-handoff.md), [tokens](../../design-tokens/README.md) | Ready with proposed assumptions as execution brief; partial canvas exists, authoring quota-blocked; no complete prototype or accepted assets/tokens |
