...
- **Next dependency-ordered backend/evidence work:** [T-101](backlog.md#t-101) has Step A/C plans, a partial Step B inventory and three bounded [C2 device runs](../08-research/2026-09-19-t101-c2-device-evidence.md). The source-only activity/ledger generation repair passes 33 host cases; review its commit and exact artifacts before considering a fresh, narrow C2-12 device authorization. Host evidence does not revise the stale-result device failure. T-104 waits for sent-photo route/device evidence and the applicable device-safety boundary.
