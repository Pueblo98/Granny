...
- **Next dependency-ordered backend/evidence work:** [T-101](backlog.md#t-101) has Step A/C plans, a partial Step B inventory and a host-built [C2 lab scaffold](../../experiments/c2-screen-explanation/README.md) with hashed APKs, prepared C2-07/C2-10 controls and 14 passing pure unit cases. Device installation, debugging changes, capture consent and C2-01–C2-12 require a separate exact authorization after commit/APK/oracle review. T-104 waits for sent-photo route/device evidence and the applicable device-safety boundary.
