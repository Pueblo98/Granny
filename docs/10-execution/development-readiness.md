...
- **Next dependency-ordered backend/evidence work:** [T-101](backlog.md#t-101) has Step A/C plans, a partial Step B inventory and a first [C2 device ledger](../08-research/2026-09-19-t101-c2-device-evidence.md). Before any rerun, separately authorize source-only repair and review of protected-content/stale-frame handling plus deterministic Stop/revoke/resize/process-loss oracles; the current APKs must not be rerun. T-104 waits for sent-photo route/device evidence and the applicable device-safety boundary.
