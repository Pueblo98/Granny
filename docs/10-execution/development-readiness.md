...
| Figma/token handoff | [Figma](../02-design/figma.md), [tokens](../../design-tokens/README.md) | Ready with proposed assumptions as execution brief; no Figma file or accepted assets/tokens |
