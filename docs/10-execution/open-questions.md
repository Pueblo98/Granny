...
| OQ-12 · Simon + evidence | Find real permitted route to person/date/photo and media/message postconditions. Current Spotify policy prohibits Granny's accepted voice-assistant playback behavior; Apple MusicKit is an unreviewed desk lead, not a route selection | Choose a policy-compatible media provider/integration, revise the media outcome, replace a workflow or explicitly revisit ADR-0009's two-external-job bar. App intents/tree and honest message handoff remain insufficient as verified external completion | [Refreshed route inventory](../08-research/2026-09-19-t101-route-inventory.md); EVAL-001/003/004; GATE-03/04/07; no provider/account/device action authorized |
