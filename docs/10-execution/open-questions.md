...
Open decisions are the least cluttered Rooms entry, zero/default/user-created starting set, final product term, cross-room source disclosure threshold, private-room semantics and allowed visual variation. Resolve them through the T-119 fictional-data prototype and EVAL-008/012 before persistent data or release admission. PRD-FR-022, UC-026, J-009, SCR-016/017, CMP-011 and CAP-15 now provide stable owners. This direction does not reopen ADR-0014 or add a room grid to Home.
