...
**One choice remains; five are decided:** [Simon's 2026-09-17 class brainstorm](../08-research/source-material/2026-09-17-class-brainstorming.md) reinforces conversation-led entry, contextual result modules, optional guidance/annotations, Android delivery and an orchestrator posture. Simon retained consequence-based approval and the MVP/App V1/later split. He accepted automatic important-fact capture plus bounded adaptive communication in [ADR-0012](../09-decisions/ADR-0012-automatic-memory-and-adaptive-communication.md), and accepted [bounded semantic interface composition](../09-decisions/ADR-0013-bounded-interface-composition.md). The [alignment brief](brainstorming-alignment.md) expands the remaining Home decision with five low-clutter directions and recommends testing a stable anchor plus one optional context layer. No persistent Home contract changes until Simon chooses.
