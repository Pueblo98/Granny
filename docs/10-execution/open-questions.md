...
| OQ-12 · Simon + evidence | Find real permitted route to person/date/photo and media/message postconditions. Android's standard play-from-search intent is selected for a narrow T-124 handoff experiment; it avoids starting with a provider SDK but does not verify playback or Pause. Spotify's SDK route remains policy no-go | First test exact handler discovery/intent construction offline, then under separate authority name the device handler/version and review provider terms plus an independent player-state oracle. If the handoff cannot mature beyond `requested`, choose an owner integration, revise the outcome, replace a workflow or revisit ADR-0009's bar | [Refreshed route inventory](../08-research/2026-09-19-t101-route-inventory.md); [T-124](backlog.md#t-124); EVAL-001/003/004; GATE-03/04/07; no provider/account/device action authorized |
