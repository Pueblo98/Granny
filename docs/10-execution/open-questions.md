...
**Two choices remain; four are decided:** [Simon's 2026-09-17 class brainstorm](../08-research/source-material/2026-09-17-class-brainstorming.md) reinforces conversation-led entry, contextual result modules, optional guidance/annotations, Android delivery and an orchestrator posture. Simon retained consequence-based approval and the MVP/App V1/later split. He accepted automatic important-fact capture for App V1 and setup-selected communication preferences followed by bounded silent optimization in [ADR-0012](../09-decisions/ADR-0012-automatic-memory-and-adaptive-communication.md). The [alignment brief](brainstorming-alignment.md) now expands the two remaining coupled choices: conversation, dashboard or pinned-shelf Home; and fixed, free-form or bounded-composition interface generation. No Home/component contract changes until Simon chooses.
