...
T-101 remains in progress; GATE-03/04 and GATE-06 device/real-data conditions remain open. The [lab-only Android 16 scaffold](../../experiments/c2-screen-explanation/README.md) had one bounded [C2 device run](../08-research/2026-09-19-t101-c2-device-evidence.md) with a repeated protected-content failure, aborted Stop attempt, inconclusive/unrun lifecycle cases and unresolved package identity. A later source-only repair adds temporal freshness plus explicit bounded lifecycle controls and passes 29 host cases; its new hashed APKs are unrun. Both first-run packages were removed and debugging restored. T-104 still waits for actual sent-photo route and device-safety evidence.
...
Evidence-led foundation: MVP/control review T-100 and the bounded offline T-103 core are complete. T-101 Step A/C plans, partial Step B inventory, first C2 device ledger and an unrun source-only repair now exist. Next, review the repair commit/APK digests and the temporary-unresponsiveness event before separately authorizing or rejecting a bounded rerun; the first-run APKs must not be reused. T-104 waits for sent-photo route/device evidence. Produce/test low-fi interaction and iterate naming/identity (T-102/108) within their authorization and evidence boundaries. Do not begin broad MVP implementation or personal-data automation.
