...
its cause and complete resolution are unproven. The separately authorized
[local OCR slice](sessions/2026-09-20-perception-local-ocr.md) adds v0.4 source,
but dependency-host timeouts block compilation; no new APK/device evidence exists.
Arbitrary-app access and production admission remain unimplemented/open.
