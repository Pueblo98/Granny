...
| THR-17 | Generated-interface deception — Model/content proposes an unknown control, hides consequence, duplicates approval or creates unsafe focus/order | Accidental or misunderstood action; inaccessible escape | ADR-0013 registered CMP IDs/versions/slots/actions only; renderer-owned semantics/reflow; stable Stop/Talk/Type; whole-plan rejection and known fallback | EVAL-007/010/012 composition attacks and comprehension | Approved component combinations may still confuse | design + agent + safety | GATE-05/06 |
