...
> **Granny modification notice:** The frontmatter and this guardrail were added to Google's upstream skill at commit `bac232fd02b0855df9275281a2a7a47643768719`. Follow repository `AGENTS.md` first. Use this only for a separately authorized native Compose task after inspecting the actual project and target SDK. Raising the SDK, changing manifests/dependencies or claiming device correctness requires the owning task's scope and evidence; this skill does not authorize those changes by itself.
