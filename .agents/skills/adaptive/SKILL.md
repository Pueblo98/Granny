...
metadata:
  ...
  upstream_last_updated: '2026-08-27'
  keywords:
  - android
  - ui
  - adaptive
...
> **Granny modification notice:** The frontmatter and this guardrail were added to Google's upstream skill at commit `bac232fd02b0855df9275281a2a7a47643768719`. Follow repository `AGENTS.md` first. Use this skill only for a separately authorized native Compose review or implementation task. Do not create/migrate an Android project, adopt Navigation 3 or experimental APIs, install dependencies, or treat browser fixtures as device evidence merely to satisfy an upstream prerequisite. Record any missing prerequisite as a proposal or blocker under the owning task and Definition of Ready.
