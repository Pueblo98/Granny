---
name: testing-setup
description: Analyze a native Android app's testing strategy and, when explicitly authorized,
  set up bounded unit, UI, screenshot, or end-to-end test infrastructure. Use for a real
  Android project, not the browser design prototype or offline product-evidence claims.
license: Complete terms in LICENSE.txt
metadata:
  owner: Simon
  status: proposed
  last_updated: '2026-09-14'
  upstream_author: Google LLC
  upstream_commit: bac232fd02b0855df9275281a2a7a47643768719
  upstream_last_updated: '2026-09-03'
  keywords:
  - android
  - testing
  - ui tests
...
> **Granny modification notice:** The description, frontmatter and this guardrail were adapted from Google's upstream skill at commit `bac232fd02b0855df9275281a2a7a47643768719`. Follow repository `AGENTS.md` first. Analysis/review is read-only. Installing libraries, choosing DI/testing frameworks, changing build files, creating device tests or updating repository instructions requires an explicitly authorized implementation task that meets Definition of Ready. Prefer existing dependencies and fake/synthetic boundaries; do not convert screenshot or fixture passes into Android, accessibility or user evidence.
