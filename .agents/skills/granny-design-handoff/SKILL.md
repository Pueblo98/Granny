...
Hand off actual frame/source references if created, otherwise the manifest; coverage and missing variants; accepted/proposed token values; research questions; validation and remaining authority. Do not implement UI code unless explicitly requested.
